...
type SidebarProviderRef = HTMLDivElement & { setOpen?: (open: boolean) => void };
...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, passedRef) => {
  ...
  React.useImperativeHandle(passedRef, () => ({ setOpen, ...(ref.current as HTMLDivElement) }), [setOpen]);
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background min-h-0",
...
>(({ className, isActive, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative rounded-lg data-[active=true]:bg-muted data-[active=true]:bg-opacity-40", className)}
    {...props}
  />
));
